 ...
 */
class StationsAdapter(spanWidth: Int, listener: OnStationListener) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    init {
        adapters.put(DisplayedEntity.CITY, HeaderAdapterDelegate(spanWidth))
    ...
    fun getSpanSize(position: Int): Int {
        return adapters[getItemViewType(position)].getSpanSize()
    }
